...
(function() {
    ...
    function parse(k, l = "@") {
        ...
        if (u > s || !e) {
                            ...
                            e: while (1) {
                                ...
                                a: do {
                                    switch (i[a >> 1] | 0) {
                                        ...
                                        case 40:
                                            {
                                                r = t[57] | 0;c = t[59] | 0;b = i[379] | 0;i[379] = b + 1 << 16 >> 16;t[c + ((b & 65535) << 2) >> 2] = r;b = 74;
                                                break
                                            }
                                        case 41:
                                            {
                                        ...
                                        case 123:
                                            {
                                                ...
                                                } while (0);r = i[379] | 0;b = r & 65535;s[u + b >> 0] = s[765] | 0;s[765] = 0;c = t[59] | 0;i[379] = r + 1 << 16 >> 16;t[c + (b << 2) >> 2] = e;b = 74;
                                                break
                                            }
                                        case 125:
                                            {
                                                ...
                                                default:
                                                    {
                                                        a = t[57] | 0;r = i[a >> 1] | 0;r: do {
                                                            if (!(U(r) | 0)) {
                                                                ...
                                                                e = f[379] | 0;
                                                                if (!(p(t[(t[59] | 0) + (e << 2) >> 2] | 0) | 0) ? (s[u + e >> 0] | 0) == 0 : 0) b = 68;
                                                                else b = 71;
                                                            } else switch (r << 16 >> 16) {
                                                                case 46:
                        ...
                        if ((c | 0) == 3) {
                            a: do {
                                switch (a << 16 >> 16) {
                                    ...
                                    case 42:
                                        {
                                            t[61] = e + 2;w(1) | 0;c = t[61] | 0;C(c, c) | 0;c = 34;
                                            break
                                        }
                                    default:
                                        {}
                            ...
                            } else if ((c | 0) == 34) a = w(1) | 0;e = t[61] | 0;
                ...
                function l() {
                    ...
                    e: do {
                        switch ((w(1) | 0) << 16 >> 16) {
                            case 40:
                                {
                                    e = t[61] | 0;a = t[59] | 0;r = i[379] | 0;i[379] = r + 1 << 16 >> 16;t[a + ((r & 65535) << 2) >> 2] = e;
                                    if ((i[t[57] >> 1] | 0) != 46) {
                                        e = t[61] | 0;
                                        t[61] = e + 2;
                                        r = w(1) | 0;
                                        ...
                                        switch ((w(1) | 0) << 16 >> 16) {
                                            case 44:
                                                {
                                                    t[61] = (t[61] | 0) + 2;w(1) | 0;r = t[51] | 0;t[r + 4 >> 2] = e;f = t[61] | 0;t[r + 16 >> 2] = f;s[r + 24 >> 0] = 1;t[61] = f + -2;
                                                    break e
                                                }
                                            case 41:
                                                {
                                                    i[379] = (i[379] | 0) + -1 << 16 >> 16;f = t[51] | 0;t[f + 4 >> 2] = e;t[f + 12 >> 2] = (t[61] | 0) + 2;s[f + 24 >> 0] = 1;i[378] = (i[378] | 0) + -1 << 16 >> 16;
                                                    break e
                                                }
                                            default:
                                                {
                            ...
                            case 123:
                                {
                                    ...
                                    if ((c | 0) == 31) t[61] = (t[61] | 0) + 2;w(1) | 0;e = t[61] | 0;
                                    if (m(e, 50, 8) | 0) {
                                        L();
                                        break e
                                    }
                            ...
                            if (s ? (m(a + 2 | 0, 58, 10) | 0) == 0 : 0) {
                                ...
                                e: while (1) {
                                    ...
                                    switch (r << 16 >> 16) {
                                        case 39:
                                            {
                                                d(39);t[61] = (t[61] | 0) + 2;r = w(1) | 0;
                                                break
                                            }
                                        case 34:
                                            {
                                                d(34);t[61] = (t[61] | 0) + 2;r = w(1) | 0;
                                                break
                                            }
                                        default:
                                            r = E(r) | 0;
            ...
            }("undefined" != typeof self ? self : global, {}, a), r = e.su(s - (2 << 17));
        }
